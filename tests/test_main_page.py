...
class TestLoginFromMainPage():
    def test_guest_can_go_to_login_page(self, browser):  # Этот тест проверяет переход на страницу логина с главной страницы.
    ...
    def test_guest_should_see_login_link(self, browser):  # Этот тест проверяет, отображается ли ссылка "Войти" на главной странице.
        link = "http://selenium1py.pythonanywhere.com/"
        page = MainPage(browser, link)  # инициализируем Page Object, передаем в конструктор экземпляр драйвера и url адрес
